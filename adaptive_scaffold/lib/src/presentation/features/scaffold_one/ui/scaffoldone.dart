...
import 'package:adaptive_scaffold/src/presentation/widgets/adaptive_app_bar.dart';
...
class ScaffoldOne extends StatefulWidget {
  const ScaffoldOne({Key? key}) : super(key: key);

  @override
  _ScaffoldOneState createState() => _ScaffoldOneState();
}

class _ScaffoldOneState extends State<ScaffoldOne> {
