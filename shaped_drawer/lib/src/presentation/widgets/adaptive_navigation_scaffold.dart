...
import 'package:shaped_drawer/src/presentation/widgets/adaptive_breakpoints.dart';
import 'package:shaped_drawer/src/presentation/widgets/wave_drawer.dart';
...
class AdaptiveNavigationScaffold extends StatelessWidget {
  ...
  WaveDrawer _defaultDrawer(List<AdaptiveScaffoldDestination> destinations) {
    return WaveDrawer(
      semanticLabel: '',
      boundaryWidth: 8,
      width: 80,
    ...
    Row(
      children: [
        ...
        Container(
          ...
          boundaryColor: Colors.blue.shade800,
          boundaryWidth: 8,
          child: Column(
            children: [
              // TODO: Find a better way to write `drawerHeader!`
