...
import 'package:shaped_drawer/src/presentation/widgets/adaptive_app_bar.dart';
import 'package:shaped_drawer/src/presentation/widgets/adaptive_navigation_scaffold.dart';
...
class _MineScaffoldDemoState extends State<MineScaffoldDemo> {
  ...
  Widget build(BuildContext context) {
    return AdaptiveNavigationScaffold(
      ...
      appBar: AdaptiveAppBar(title: const Text('mine Demo')),
      body: _body(),
